#!/usr/bin/env bash
# ============================================================
# Chạy flow OpenROAD cho Sky130HD
...
# File này: OPENROAD_HOME/Sky130_Workspace/run.sh
...
echo "========================================"
echo " Running: $PROJECT on Sky130HD"
echo "========================================"
...
echo " $ORFS/flow/results/sky130hd/$PROJECT/base/"
echo "========================================"
